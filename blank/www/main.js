...
module.exports = "<ion-header>\n    <ion-toolbar>\n      <ion-title text-center>\n        Admin Controls\n      </ion-title>\n    </ion-toolbar>\n  </ion-header>\n\n  <ion-card>\n      <ion-card-content>\n          <ion-input [(ngModel)]=\"usernameString\" placeholder=\"Username\"></ion-input>\n          <ion-input [(ngModel)]=\"passwordString\" placeholder=\"Password\"></ion-input>\n      </ion-card-content>\n  </ion-card>\n\n  <ion-card>\n      <ion-card-content>\n          <h2>Delete</h2>\n          <ion-input [(ngModel)]=\"deleteID\" placeholder=\"ID\"></ion-input>\n\n          <ion-fab vertical=\"center\" horizontal=\"end\" slot=\"fixed\">\n              <ion-fab-button size=\"small\" (click)=\"deletePOI()\" color=\"danger\">\n                <ion-icon name=\"trash\"></ion-icon>\n              </ion-fab-button>\n          </ion-fab>\n      </ion-card-content>\n  </ion-card>\n\n  <ion-card>\n      <ion-card-content>\n          <h2>Create</h2>\n          <ion-input [(ngModel)]=\"addPOI\" placeholder=\"Object Data\"></ion-input>\n\n          <ion-fab vertical=\"center\" horizontal=\"end\" slot=\"fixed\">\n              <ion-fab-button size=\"small\" (click)=\"createPOI()\">\n                <ion-icon name=\"checkmark\"></ion-icon>\n              </ion-fab-button>\n          </ion-fab>\n      </ion-card-content>\n  </ion-card>\n\n  <ion-card>\n      <ion-card-content>\n          <h2>Update</h2>\n          <ion-input [(ngModel)]=\"updateID\" placeholder=\"ID\"></ion-input>\n          <ion-input [(ngModel)]=\"updatePOI\" placeholder=\"Object Data\"></ion-input>\n\n          <ion-fab vertical=\"center\" horizontal=\"end\" slot=\"fixed\">\n              <ion-fab-button size=\"small\" (click)=\"changePOI()\">\n                <ion-icon name=\"checkmark\"></ion-icon>\n              </ion-fab-button>\n          </ion-fab>\n      </ion-card-content>\n  </ion-card>\n\n  <ion-fab vertical=\"bottom\" horizontal=\"end\" slot=\"fixed\">\n      <ion-fab-button (click)=\"dismiss()\">\n        <ion-icon name=\"arrow-back\"></ion-icon>\n      </ion-fab-button>\n    </ion-fab>\n\n<ion-content>\n\n</ion-content>\n"
...
var AdminPage = /** @class */ (function () {
    function AdminPage(http, modalController) {
        this.http = http;
        this.modalController = modalController;
    }
    AdminPage.prototype.ngOnInit = function () {
    };
    AdminPage.prototype.deletePOI = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                this.http.delete("https://poiapi.herokuapp.com/" + this.usernameString + "/" + this.passwordString + "/pois/" + this.deleteID).subscribe(function (response) {
                });
    ...
    AdminPage.prototype.createPOI = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                this.http.post("https://poiapi.herokuapp.com/" + this.usernameString + "/" + this.passwordString + "/pois/", JSON.parse(this.addPOI), {}).subscribe(function (response) {
                });
                this.modalController.dismiss();
                return [2 /*return*/];
            });
    ...
    AdminPage.prototype.changePOI = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                this.http.patch("https://poiapi.herokuapp.com/" + this.usernameString + "/" + this.passwordString + "/pois/" + this.updateID, JSON.parse(this.updatePOI)).subscribe(function (response) {
                });
                this.modalController.dismiss();
                return [2 /*return*/];
            });
    ...
    AdminPage.prototype.dismiss = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                this.modalController.dismiss();
                return [2 /*return*/];
    ...
    AdminPage = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        ...
        tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_angular_common_http__WEBPACK_IMPORTED_MODULE_3__["HttpClient"], _ionic_angular__WEBPACK_IMPORTED_MODULE_2__["ModalController"]])
    ], AdminPage);
    return AdminPage;
}());
...
/* harmony import */ var _admin_admin_page__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./admin/admin.page */ "./src/app/admin/admin.page.ts");
...
var AppModule = /** @class */ (function () {
    ...
    AppModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
            declarations: [_app_component__WEBPACK_IMPORTED_MODULE_7__["AppComponent"], _admin_admin_page__WEBPACK_IMPORTED_MODULE_10__["AdminPage"]],
            entryComponents: [_admin_admin_page__WEBPACK_IMPORTED_MODULE_10__["AdminPage"]],
...
module.exports = __webpack_require__(/*! /Users/jimmygzzmtz/Documents/GitHub/POIAPP/blank/src/main.ts */"./src/main.ts");
